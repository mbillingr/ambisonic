    ...
    I::Item: Sample,
{
    ...
    pub fn new(input: I) -> Self {
        Reverb {
            ...
            aps: vec![AllPass::new(100, Bweights::new(-0.5, -0.5, -0.5, -0.5), Bweights::new(0.5, 0.5, 0.5, 0.5)),
                      AllPass::new(1100, Bweights::new(-0.5, -0.5, -0.5, -0.5), Bweights::new(0.5, 0.5, 0.5, 0.5)),
                      AllPass::new(120, Bweights::new(-0.5, -0.5, -0.5, -0.5), Bweights::new(0.5, 0.5, 0.5, 0.5)),
                      AllPass::new(1300, Bweights::new(-0.5, -0.5, -0.5, -0.5), Bweights::new(0.5, 0.5, 0.5, 0.5)),
                      ...
                      AllPass::new(10000, Bweights::new(-0.5, -0.5, -0.5, -0.5), Bweights::new(0.5, 0.5, 0.5, 0.5)),
                      AllPass::new(8000, Bweights::new(-0.5, -0.5, -0.5, -0.5), Bweights::new(0.5, 0.5, 0.5, 0.5)),
                      AllPass::new(150, Bweights::new(-0.5, -0.5, -0.5, -0.5), Bweights::new(0.5, 0.5, 0.5, 0.5))],
        }
    }
}
